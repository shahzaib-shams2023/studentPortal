  ...
  <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{URL:: to('/network_insert_')}}" method="post">
          @csrf
          <div class="modal-body">
            <div class="d-flex flex-row align-items-center mb-4">
              <i class="fas fa-user fa-lg me-3 fa-fw"></i>
              <div class="form-outline flex-fill mb-0">
              <input type="text" id="form3Example1c" class="form-control" name="network" required/>
              <label class="form-label" for="form3Example1c">Network Name</label>
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach($network as $sof)

                            <tr>
                                <td>{{$sof->id}}</td>
                                <td>{{$sof->Network_issue}}</td>
                                <td>
...
<div class="modal fade" id="updatemodal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{URL:: to ('net_update_records_')}}" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="modal-body">
  ...
  $.ajax({
    ...
    success:function(result)
    {
      ...
      $("#userid").val(res["id"]);
      $("#numberinput").val(res["Network_issue"]);
