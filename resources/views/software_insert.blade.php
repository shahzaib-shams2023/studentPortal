                ...
                <form action="{{URL::to('/software_insert_')}}" method="post">
                  @csrf
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1c" class="form-control" name="softwareinput" required/>
...
<div class="modal fade" id="updatemodal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{URL:: to ('update_records_')}}" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="modal-body">
  ...
  $.ajax({
    ...
    success:function(result)
    {
      ...
      $("#userid").val(res["id"]);
      $("#numberinput").val(res["software_name"]);
