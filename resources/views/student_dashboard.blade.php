      ...
      <div class="main-container">
        <div class="row">
          <div class="card-container">
            ...
            <!-- attendances -->
            <div class="first-card first" data-aos="zoom-in" data-aos-duration="150" data-aos-offset="10"
          ...
          <a href="/attendances" class="author" style="text-decoration:none; color:inherit; ">
            ...
            <div class="description">
              <img src="dashboard/images/attendance.jpg" style="width:100px; height: 100px; " class="mt-3"
              alt="">
              <br><br>
        ...
        @endforeach
            ...
            <!-- announcment -->
            <div class="first-card " data-aos="zoom-in" data-aos-duration="150" data-aos-offset="10"
          ...
          <a href="/announcement" style="text-decoration:none; color:inherit; ">
            ...
            <div class="description">
              ...
              <p> <b> Announcement Image </b><span> <img src="dashboard/images/{{$annu->Sem_img}}"
                alt=""></span></p>
        ...
        @endforeach
            ...
            <div class="first-card" class="first-card " data-aos="zoom-in" data-aos-duration="100"
              data-aos-anchor="#example-anchor" data-aos-offset="10" data-aos-delay="100" data-aos-duration="10">
              <a href="/examfetch" style="text-decoration:none;">
                <a href="/examfetch" class="author" style="text-decoration:none; color:inherit; ">
                  <div class="blog-card">
                    <div class="description">
                      <img class="mt-2" src="dashboard/images/exam.png" style="width:100px; height: 100px;" class="mt-3"
                        alt="">
                      <br><br>
                     ...
                     $date = Carbon::now()->format('Y-m-d');
                      ...
                      // Find the first scheduled exam
                      $exam = $examAssignedBatch->first(function($exam) use ($date, $time) {
                          return $exam->exam_date == $date && $exam->Start_Time <= $time && $exam->End_Time >= $time;
                      });
                      ?>
                      
                      @if($exam)
                          {{-- Exam is scheduled --}}
                          <span class="span">Your Exam Is Scheduled</span>
                          <p><b> Semester : </b><span>{{ $exam->semester_id }}</span></p>
                          <p><b> Student Id : </b><span>{{ session('std_id') }}</span></p>
                          <p><b> Batch Name : </b><span>{{ $exam->Batch }}</span></p>
                          <p><b> Exam Date : </b><span>{{ \Carbon\Carbon::parse($exam->exam_date)->format('d-M-Y') }}</span></p>
                          <a href="{{ route('examDetails') }}" class="btn btn-success">Attempt Exam</a>
                      @else
                          {{-- Either no scheduled exam or none assigned --}}
                          <span class="span">Your Exam Isn't Scheduled</span>
                          <p><b> Semester : </b><span>{{ $student->sem }}</span></p>
                          <p><b> Student Id : </b><span>{{ $student->Std_id }}</span></p>
                          <p><b> Batch Name : </b><span>{{ $student->Batch }}</span></p>
                      
                          @php
                              $upcoming = $examAssignedBatch->firstWhere('exam_date', '>', $date);
                          @endphp
                      
                          @if($upcoming)
                              <p><b>Upcoming Exam : </b><span>{{ \Carbon\Carbon::parse($upcoming->exam_date)->format('d-m-Y') }}</span></p>
                          @else
                              <button class="btn btn-success" disabled>No Exams Available</button>
                          @endif
                      @endif
            ...
            <!-- jobs -->
            <div class="first-card " data-aos="flip-down" data-aos-duration="150" data-aos-anchor="#example-anchor"
              data-aos-offset="10" data-aos-delay="100" data-aos-duration="10">
          ...
          <a href="/attendances" class="author" style="text-decoration:none; color:inherit; ">
            <div class="blog-card">
            <div class="description">
              <img src="dashboard/images/jobs.jpg" style="width:120px; height: 110px; " class="mt-3" alt="">
              <br><br>
              <h1>jobs Schedule</h1>
      ...
      <div class="row">
        <div class="tables">
          ...
          <div class="col-lg-12 col-md-12 grid-margin stretch-card"
            style="display:flex; justify-content:center; align-item:center; background-color:white;"
            data-aos-duration="100" data-aos="flip-down" data-aos-anchor="#example-anchor" data-aos-offset="10"
            data-aos-delay="100" data-aos-duration="150">
